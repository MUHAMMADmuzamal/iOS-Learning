...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let rootViewController = UINavigationController(rootViewController: CompositionalLayoutCollectionViewController(nibName: CompositionalLayoutCollectionViewController.identifier, bundle : nil))
